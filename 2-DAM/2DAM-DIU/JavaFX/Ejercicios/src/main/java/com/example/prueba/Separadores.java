...
public class Separadores extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Separator separador = new Separator(); // Es el separador
            ObservableList<Object> laborables = FXCollections.observableArrayList("Lunes", "Martes", "Miércoles", "Jueves", "Viernes", separador, "Sábado", "Domingo");
