...
public class VistaTabla extends Application {
    ...
    public static class Personaje {
        private final SimpleStringProperty nombre; // SimpleStringProperty --> Crea una propiedad observable de tipo String.
    ...
    final ObservableList<Personaje> personajes = FXCollections.observableArrayList( // FXCollections --> proporciona métodos estáticos para crear y manipular colecciones observables
